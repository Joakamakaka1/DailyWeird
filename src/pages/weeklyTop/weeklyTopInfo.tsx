  ...
  return (
    <main className="w-full mx-auto px-4 sm:px-8 bg-[#131516] min-h-screen text-white">
      ...
      <section className="w-full text-center mt-16 mb-10 px-4 py-4">
        ...
        <div className="relative w-full max-w-3xl mx-auto aspect-video rounded-3xl overflow-hidden border border-gray-200 shadow-md bg-gradient-to-r from-[#1e2021] to-[#2a2d2e]">
          {/* Loader centrado */}
          {!data?.image_url && (
        ...
        <div className="lg:w-2/3 flex flex-col gap-12">
          {data?.items?.map((item, idx) => (
            <article
              ...
              className="bg-gradient-to-r from-[#1e2021] to-[#2a2d2e] border border-[#7a7164]/40 p-8 rounded-2xl shadow-sm cursor-pointer hover:border-[#c5ff75]/60 transition-all"
            >
              {" "}
              <h3
